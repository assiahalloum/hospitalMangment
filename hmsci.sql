...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 17 sep. 2023 à 13:38
...
--
-- Déchargement des données de la table `accountant`
--
...
--
-- Déchargement des données de la table `blood_bank`
--
...
--
-- Déchargement des données de la table `blood_donor`
--
...
CREATE TABLE `diagnosis_report` (
  ...
  `report_type` longtext NOT NULL COMMENT 'xray,blood test',
  `document_type` longtext NOT NULL COMMENT 'text,photo',
...
--
-- Déchargement des données de la table `diagnosis_report`
--
...
(14, 'achraf', 'achraf@mail.com', '123456789', 'hay el massira 2 rue 4 num 8', '+212659349564', 20, 'Mr');
...
--
-- Déchargement des données de la table `laboratorist`
--
...
CREATE TABLE `medicine` (
  ...
  `manufacturing_company` longtext NOT NULL,
...
--
-- Déchargement des données de la table `medicine_category`
--
...
CREATE TABLE `message` (
  ...
  `user_from_type` longtext NOT NULL,
  `user_from_id` int(11) NOT NULL,
  `user_to_type` longtext NOT NULL,
...
(24, 'fatima', 'fatima@mail.com', 'P@ssw0rd', 'casablanca anfa', '0666666666');
...
(17, 'Anas', 'anas@gmail.com', 'P@ssw0rd', '', '0666666666', 'male', '07/18/2000', 0, 'O+', 1694375665);
...
(6, 1651170030, 11, 11, 'Test. Test Test. Test Test. Test Test. Test', 'Test. Test Test. Test Test. Test Test. Test', 'Test. Test Test. Test Test. Test', 'Test. Test Test. Test Test. Test'),
(4, 1651161041, 8, 15, 'This is a demo case history for testing purpose!', 'This is a sample medication for testing purpose!', 'This is a sample medication for testing purpose!', 'This is a demo description for testing purpose!');
...
CREATE TABLE `report` (
  ...
  `type` longtext NOT NULL COMMENT 'operation,birth,death',
  `description` longtext NOT NULL,
  `timestamp` int(11) NOT NULL,
  `doctor_id` int(11) NOT NULL,
  `patient_id` int(11) NOT NULL
...
(6, 'birth', 'test', 1694395780, 7, 12),
(5, 'other', 'test', 1694395742, 14, 8);
...
--
-- Index pour la table `bed_allotment`
--
ALTER TABLE `bed_allotment`
  ADD PRIMARY KEY (`bed_allotment_id`);

--
-- Index pour la table `blood_bank`
--
ALTER TABLE `blood_bank`
  ADD PRIMARY KEY (`blood_group_id`);

--
-- Index pour la table `blood_donor`
--
...
--
-- Index pour la table `diagnosis_report`
--
...
--
-- Index pour la table `noticeboard`
--
...
--
-- AUTO_INCREMENT pour la table `diagnosis_report`
--
ALTER TABLE `diagnosis_report`
...
--
-- AUTO_INCREMENT pour la table `noticeboard`
--
ALTER TABLE `noticeboard`
...
--
ALTER TABLE `nurse`
  MODIFY `nurse_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
