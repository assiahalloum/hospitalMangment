            ...
            <div class="span4 offset4">
                <div class="padded">
                    <center>
                        ...
                        <h4 style="color: black;"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp YaaS Hospitals</h4></a>
                    </center>
                    <div class="login box" style="margin-top: 10px;">
                        ...
                        <i class="m-icon-swapright m-icon-white"></i>
                        	<?php echo form_open('login' , array('class' => 'separate-sections'));?>
                                <div class="">
                                    ...
                                    <select class="validate[required]" name="login_type" style="width:100%;">
                                        ...
                                        <<option value="pharmacist"><?php echo ('RH');?></option>
                                    </select>
                            ...
                            <div>
                                ...
                                <a  href="index.php" style="color: black;" style> <?php echo ('Home');?></a>
