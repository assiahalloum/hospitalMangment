...
<head> 
  ...
  <title>Home</title>
  <link href="<?php echo base_url();?>template/css/style.css" media="screen" rel="stylesheet" type="text/css" />
  <!-- css -->
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>template/css/animate.css" media="screen" rel="stylesheet" type="text/css" >
  <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans&display=swap" rel="stylesheet">
  

  <!-- boxed bg -->
  <!-- template skin -->
  <link href="<?php echo base_url();?>template/color/default.css" media="screen" rel="stylesheet" type="text/css" />
...
<body>
  ...
  <div class="container navigation" style="background: -webkit-linear-gradient(left, #3931af, #00c6ff);width: 98.85vw;height: 70px;padding-top: 10px;">
        ...
        <div class="navbar-header page-scroll">
          ...
          <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 0px;font-family: 'IBM Plex Sans', sans-serif;"><h4 style="color: white;"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp YaaS Hospitals</h4></a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="active" style="margin-right: 40px;font-family: 'IBM Plex Sans', sans-serif;"><a href="index.php?login" style="color: white">LOGIN</a></li>
...
<section id="intro" class="intro"  style="font-family: 'IBM Plex Sans', sans-serif;">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="wow fadeInDown" data-wow-offset="0" data-wow-delay="0.1s">
                <h2 style="font-family: 'IBM Plex Sans', sans-serif;color: white">YaaS Hospitals</h2>
              </div>
            ...
            <div class="col-lg-6">
              <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                ...
                <img src="<?php echo base_url();?>template/img/dummy/img-1.png" class="img-responsive" alt=""></img>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6">
            <div class="wow fadeInLeft" data-wow-delay="0.2s">
              ...
              <img src="<?php echo base_url();?>template/img/dummy/img-6.png" class="img-responsive" alt=""></img>
            </div>
          </div>
          <div class="col-sm-3 col-md-3">
            ...
            <div class="wow fadeInRight" data-wow-delay="0.1s">
              <div class="service-box">
                <div class="service-icon">
                  <span class="fa fa-stethoscope fa-3x" style="color:#63f542"></span>
                </div>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.2s">
              <div class="service-box">
                <div class="service-icon">
                  <span class="fa fa-wheelchair fa-3x" style="color:#63f542"></span>
                </div>
                <div class="service-desc">
            ...
            <div class="wow fadeInRight" data-wow-delay="0.3s">
              <div class="service-box">
                <div class="service-icon">
                  <span class="fa fa-plus-square fa-3x" style="color:#63f542"></span>
                </div>
                <div class="service-desc">
          ...
          <div class="col-sm-3 col-md-3">
            ...
            <div class="wow fadeInRight" data-wow-delay="0.1s">
              <div class="service-box">
                <div class="service-icon">
                  <span class="fa fa-h-square fa-3x" style="color:#63f542"></span>
                </div>
                <div class="service-desc">
            ...
            <div class="wow fadeInRight" data-wow-delay="0.2s">
              <div class="service-box">
                <div class="service-icon">
                  <span class="fa fa-filter fa-3x" style="color:#63f542"></span>
                </div>
                <div class="service-desc">
  ...
  <script src="<?php echo base_url();?>template/js/jquery.appear.js"></script>
  <script src="<?php echo base_url();?>template/js/stellar.js"></script>
  <script src="<?php echo base_url();?>template/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
